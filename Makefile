...
SOURCES = \
	__init__.py \
	centroid_finder.py centroid_finder_dialog.py

PLUGINNAME = centroid_finder

PY_FILES = \
	__init__.py \
	centroid_finder.py centroid_finder_dialog.py

UI_FILES = centroid_finder_dialog_base.ui
...
QGISDIR=C:\Users\Cliente\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
